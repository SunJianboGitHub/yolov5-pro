...
if __name__ == "__main__":
    ...
    parser.add_argument('--hyps', type=str, default='/workspace/yolov5-pro/data/hyps/hyp.VOC2007-prune.yaml', help='hyp.yaml path')             # 超参数配置文件, 主要修改学习率、损失函数权重
    ...
    parser.add_argument("--save_dir", type=str, default="/workspace/yolov5-pro/runs/train/exp6", help="Save weights and logs.")                 # 日志文件的保存路径
